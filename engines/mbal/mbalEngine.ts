...
// ============================================================================
//
// Extracted 2026-08-28 to engines/fluid/blackOil.ts so the Suite's Fluid
// Systems Studio, the NextGen RC6 course and this engine all read one
// definition of Standing, Vasquez-Beggs, Glaso, Hall-Yarborough,
// Dranchuk-Abou-Kassem, McCain, Beal, Beggs-Robinson and Lee-Gonzalez-Eakin.
// The code moved unchanged; every mbal gate still pins it from here.
import {
